...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos_x, pos_y):
        super().__init__()
        self.sprites = []
        self.sprites.append(pygame.image.load('B_ging_Sprite 0.png'))
        self.sprites.append(pygame.image.load('B_ging_Sprite 1.png'))
        self.sprites.append(pygame.image.load('B_ging_Sprite 2.png'))
        self.sprites.append(pygame.image.load('B_ging_Sprite 3.png'))
        self.sprites.append(pygame.image.load('B_ging_Sprite 4.png'))
        self.sprites.append(pygame.image.load('B_ging_Sprite 5.png'))
        self.sprites.append(pygame.image.load('B_ging_Sprite 6.png'))
        self.sprites.append(pygame.image.load('B_ging_Sprite 7.png'))
        self.sprites.append(pygame.image.load('B_ging_Sprite 8.png'))
        self.sprites.append(pygame.image.load('B_ging_Sprite 9.png'))
        self.sprites.append(pygame.image.load('B_ging_Sprite 10.png'))

        # Load the idle sprite image (replace the path with your actual image path)
        self.idle_sprite = pygame.image.load('B_ging_Sprite 0.png')
